...
namespace SUPConsoleCommands {
	...
	bool ProcessCommandAndTellIfContinue(char* Text)
	{
		...
		if (Text)
		{
				...
				//if (sup::string::iequals(Text, "checkinv"))
				//{
				...
				//if (sup::string::iequals(Text, "getstateopen"))
				//{
			...
			//if (sup::string::iequals(Text, "outputgrid"))
			//{
			...
			//if (sup::string::iequals(Text, "supdebug"))
			//{
			...
			//if (sup::string::iequals(Text, "supopenlog"))
			//{
			...
			//if (sup::string::iequals(Text, "getsupversion"))
			//{
	...
	DecodedConsoleCommand GetConsoleCommandByText(string& sText){
		...
		else if (sup::string::iequals(result.sCallingRef.c_str(), "player"))
		{
