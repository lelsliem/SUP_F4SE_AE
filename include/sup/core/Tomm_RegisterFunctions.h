...
// Phase 3: f4se/PapyrusDelayFunctors.h is not available under CommonLibF4; the
// DECLARE_DELAY_FUNCTOR macro it provided is unused in this file.
...
bool RegisterFuncs(VirtualMachine* vm) {
	...
	vm->RegisterFunction(new NativeFunction0<StaticFunctionTag, SUPUserTimeStruct>("GetUserTimeStruct", pluginName, cmd_GetUserTimeStruct, vm));
