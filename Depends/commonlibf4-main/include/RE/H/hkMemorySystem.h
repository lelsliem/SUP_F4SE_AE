...
namespace RE
{
	...
	public:
		...
		virtual hkResult             GetHeapSoftLimit([[maybe_unused]] std::int32_t a_numBytes) { return hkResult::kFailure; }                                                                                                                                          // 05
		...
		virtual hkResult             GetMemorySnapshot([[maybe_unused]] hkMemorySnapshot& a_snapshot) const { return hkResult::kFailure; }                                                                                                                              // 11
