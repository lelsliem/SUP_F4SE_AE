...
// Phase 3: the hard-coded F4SE precompiled header include is gone.
...
static char* InputBoxHelper(const char* Prompt, const char* Title, const char* Default) {
    ...
    //string Evaluation = "InputBox(\"" + strPrompt + "\", \"" + strTitle + "\", \"" + strDefault + "\", \"" + "100" + "\", \"" + "100" + "\", \"" + "www.nexusmods.com/users/myaccount?tab=api%20access" + "\", \"" + "0" + "\")";
